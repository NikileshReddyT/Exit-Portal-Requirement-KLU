...
const RegistrationsUpload = () => {
  ...
  const downloadTemplate = () => {
    const csvContent = "Student ID,Student Name,Email,Course Code,Registration Date,Status\n2200080001,John Doe,john.doe@example.com,22CS1101,2023-08-15,ACTIVE\n2200080002,Jane Smith,jane.smith@example.com,22MT1101,2023-08-15,ACTIVE\n2200080003,Bob Johnson,bob.johnson@example.com,22CS1101,2023-08-16,ACTIVE";
        ...
        <div className="p-6">
          <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-indigo-800 space-y-1">
              ...
              <li>• Required columns: Student ID, Student Name, Email, Course Code, Registration Date, Status</li>
              <li>• File size limit: 10MB</li>
              <li>• Registrations will be associated with the current program</li>
              <li>• Course codes must exist in the system</li>
              <li>• Status should be ACTIVE, INACTIVE, or DROPPED</li>
            </ul>
          </div>
