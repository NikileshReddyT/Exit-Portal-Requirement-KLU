                ...
                <div className="p-6 flex-grow flex flex-col justify-between">
                    ...
                    <div>
                        <div className="w-full bg-gray-200 rounded-full h-2.5 relative mb-2">
                             <motion.div
                                className={`h-2.5 rounded-full ${isCategoryCompleted ? 'bg-[#018e42]' : 'bg-red-900'}`}
                                initial={{ width: '0%' }}
                            ...
                            />
                            <motion.div 
                                className={`absolute top-1/2 -translate-y-1/2 h-[13px] w-[13px] rounded-full ${isCategoryCompleted ? 'bg-[#018e42]' : 'bg-red-800'}`}
                                initial={{ left: '0%' }}
