...
public class StudentCategoryProgressDTO {
    ...
    public long getRegisteredCourses() { return registeredCourses; }
    public void setRegisteredCourses(long registeredCourses) { this.registeredCourses = registeredCourses; }
